...
enum HookSettings {
    ...
    /// 0.7.0, PostToolUse (matched to TodoWrite, for the Sessions card's task list) after 0.7.9; Repair adds them to
    ...
    /// Code's `PreToolUse`, `AskUserQuestion`; its `PostToolUse`, `TodoWrite`). This is what re-points a moved app, what turns a Cursor entry still on a plain `--hook` into
