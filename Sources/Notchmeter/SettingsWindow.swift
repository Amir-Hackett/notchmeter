...
struct SettingsView: View {
    ...
    private var sessionsSection: some View {
        Section {
            ...
            Text(L("Sessions"))
                .help(L("What the panel shows of each session, and what you can do to it from there. Sessions are found without the hook too; exact turn ends, waits, answers and the task list need the assistant's hook (Integrations)."))
        }
    }
