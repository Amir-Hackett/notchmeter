...
enum SettingsSearch {
    ...
    static func entries() -> [Entry] {
        ...
        add(.notifications, L("Notifications"), L("Notify when a window is on pace to run out"), L("Cutting it close (on track)"),
            ...
            L("When an assistant waits for you, or a turn finishes"), L("Sound"), L("Pace crossing"), L("Permission request"),
            L("Question"), L("Plan ready to approve"), L("Turn finished"), L("Quiet hours"), L("Test notification"))
