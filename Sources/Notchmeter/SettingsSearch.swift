...
/// The block a Settings row sits in: one of the thirteen `Section`s `SettingsView.paneContent` composes, plus the
...
enum SettingsSection: CaseIterable {
    case general, updates, about, panel, usage, shortcuts, assistants, transcripts, notifications, hooks, otherTools,
    ...
    var pane: SettingsPane {
        ...
        case .assistants, .transcripts: .assistants
