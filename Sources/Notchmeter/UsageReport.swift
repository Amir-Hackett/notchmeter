...
/// `source` (AgentSession.Source: `hook`, or `coworkLog` for a Claude Cowork task) per session; the five `tokenBuckets` and `cacheWrite1hShare` per cost range, `metering`, `cursor` in the cost
