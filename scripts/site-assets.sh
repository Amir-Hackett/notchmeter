...
mkdir -p site/img
for f in demo.gif expanded.png expanded-detailed.png edge-left.png edge-right-panel.png signal-rings.png compact-top.png permission.png question.png settings.png dashboard.png; do
