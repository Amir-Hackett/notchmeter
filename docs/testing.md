...
| `snapshot` | the distributed notification `com.amirhackett.notchmeter.oracle.snapshot` was received | every preference, `visibleTools`, `costCard` (`carried`, `leads`, `gaps`), `presence`, `sessions`, `awaitingInput`, `readings`, `advice`, `panelState`, `panelVisible`, `panelScreen`, `regions`, `screens`, `captured`, `settingsVisible`, `settingsFrame` |
