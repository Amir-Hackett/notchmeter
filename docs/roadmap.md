...
## Where the repository stands (2026-09-05, after the v0.1.0 release)

| | |
|---|---|
| Visibility | public since 2026-09-05, created 2026-09-02, 14 topics applied |
| Version | 0.2.0, tagged `v0.2.0`, released 2026-09-05 by `release.yml` on its own: signed, notarised, stapled `Notchmeter.dmg` plus `appcast.xml`, checked from outside the pipeline (`spctl` reports *accepted, source=Notarized Developer ID*; the DMG hashes to the cask's sha256; `releases/latest/download/appcast.xml` resolves to 0.2.0 with the 0.1.0 item still beside it). The Homebrew tap serves it |
