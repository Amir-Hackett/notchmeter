...
| Version | 0.2.0 in `scripts/Info.plist`, not yet tagged. 0.1.0, tagged `v0.1.0`, is what is released and what every installed copy is running: signed, notarised, stapled `Notchmeter.dmg` plus `appcast.xml`; Homebrew tap `Amir-Hackett/tap` works |
