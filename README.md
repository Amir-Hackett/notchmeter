...
Every figure sourced, dated and tested — here is the document: [docs/accuracy.md](docs/accuracy.md). Usage meters for Claude Code, Codex, Cursor, Antigravity / Gemini CLI and GitHub Copilot, and the sessions they are running, that say what to do about the number, not only what it is.
