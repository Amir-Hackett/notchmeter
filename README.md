...
| the same 180 s in 30 s samples | `top -l 7 -s 30 -stats pid,cpu,mem -pid <pid>` | 0.0, 1.5, 6.5, 0.0, 0.8, 0.0, 0.8 % of one core; 63 to 70 MB resident |
